...
| ---------------------------- | ----------------- | ----------------- |
| **[DjangoGym](https://github.com/shakey0/DjangoGym)** | A gym website featuring a simple yet flexible design, allowing users to learn about the gym's services and book classes, while also enabling staff to add and update various information and services related to the gym. | Python, Django, PostgreSQL, JavaScript, SortableJS, Bootstrap, CSS, HTML, Docker |
