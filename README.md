...
| ---------------------------- | ----------------- | ----------------- |
| **Movement - SaaS** | A versatile digital phone bank SaaS, enhancing campaign engagement through streamlined calling and data management for voter outreach, member support, and fundraising activities. | Ruby, Rails, React, JavaScript, PostgreSQL, Redis, SCSS, CSS, HTML, Spec, Cypress |
